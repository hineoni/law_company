...
#ifndef LAW_COMPANY_SWIFT_H
#define LAW_COMPANY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="law_company",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11law_company11AppDelegate")
...
SWIFT_CLASS("_TtC11law_company17MainFlutterWindow")
